...
export default async function DashboardPage() {
  ...
  const gradeText = user.gradeLevel === 'GRADE_4' ? 'ป.4' : 'ป.6';
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <p className="text-xl text-gray-600 mb-6">
            คุณกำลังเรียนชั้น <span className="font-bold text-primary">{gradeText}</span>
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900">คณิตศาสตร์</h2>
            </div>
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900">วิทยาศาสตร์</h2>
            </div>
